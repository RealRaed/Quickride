...
if (!isset($_SESSION['email'])) {
    // Optional: redirect to login or index.php if not logged in
...
$totalCarsQuery = "SELECT COUNT(*) AS total FROM cars";
$totalCarsResult = $conn->query($totalCarsQuery);
$totalCars = $totalCarsResult->fetch_assoc()['total'] ?? 0;

// Get available cars
$availableCarsQuery = "SELECT COUNT(*) AS available FROM cars WHERE availability = 'available'";
$availableCarsResult = $conn->query($availableCarsQuery);
$availableCars = $availableCarsResult->fetch_assoc()['available'] ?? 0;
...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="indexClient.php" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="/QuickRide/about.php" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="/QuickRide/services.php" class="nav-link">Services</a></li>
	          <li class="nav-item"><a href="/QuickRide/car.php" class="nav-link">Cars</a></li>
	          <li class="nav-item"><a href="/QuickRide/contact.php" class="nav-link">Contact</a></li>
              <span><p>Hello <?php echo htmlspecialchars($_SESSION['email']); ?> </p></span>
    					...
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						...
		    						<p class="d-flex mb-0 d-block"><a href="/Quickride/car.php" class="btn btn-primary py-2 mr-1">Book now</a> </p>
		    					</div>
		    				</div>
    					</div>
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						...
		    						<div class="d-flex mb-3">
			    						...
			    						<p class="price ml-auto">$250 <span>/day</span></p>
		    						</div>
		    						<p class="d-flex mb-0 d-block"><a href="/Quickride/car.php" class="btn btn-primary py-2 mr-1">Book now</a> </p>
		    					</div>
		    				</div>
    						...
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						...
		    						<div class="d-flex mb-3">
			    						...
			    						<p class="price ml-auto">$140 <span>/day</span></p>
		    						</div>
		    						<p class="d-flex mb-0 d-block"><a href="/Quickride/car.php" class="btn btn-primary py-2 mr-1">Book now</a></p>
		    					</div>
		    				</div>
    						...
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						...
		    						<div class="d-flex mb-3">
			    						...
			    						<p class="price ml-auto">$135 <span>/day</span></p>
		    						</div>
		    						<p class="d-flex mb-0 d-block"><a href="/Quickride/car.php" class="btn btn-primary py-2 mr-1">Book now</a> </p>
		    					</div>
		    				</div>
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <p><a href="/Quickride/car.php" class="btn btn-primary py-3 px-4">Search Vehicle</a></p>
	          </div>
					</div>
				</div>
			</div>
  ...
  <div class="block-18">
    <div class="text text-border d-flex align-items-center">
      <strong class="number"><?php echo $totalCars; ?></strong>
...
<div class="col-md-6 col-lg-4 justify-content-center counter-wrap ftco-animate"> 
  <div class="block-18">
    <div class="text text-border d-flex align-items-center">
      <strong class="number"><?php echo $availableCars; ?></strong>
      <span>Available <br>Cars</span>
    </div>
  </div>
</div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="/QuickRide/about.php" class="py-2 d-block">About</a></li>
                <li><a href="/QuickRide/car.php" class="py-2 d-block">Best Price Guarantee</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="/QuickRide/faq.php" class="py-2 d-block">FAQ</a></li>
                <li><a href="/QuickRide/contact.php" class="py-2 d-block">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
